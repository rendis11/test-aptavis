...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nama_klub && $kota_klub) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update klub set nama_klub = '$nama_klub',kota_klub='$kota_klub' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into klub(nama_klub,kota_klub) values ('$nama_klub','$kota_klub')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
    ...
    <div class="mx-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php
                    header("refresh:5;url=soal_1.php");//5 : detik
                }
                ?>
                <?php
                if ($sukses) {
                ...
                <?php
                    header("refresh:5;url=soal_1.php");
                }
                ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="soal_1.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                    <a href="soal_1.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                                </td>
                            </tr>
                        <?php
                        }
